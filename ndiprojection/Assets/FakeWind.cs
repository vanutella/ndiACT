...
public class FakeWind : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //     Debug.Log($" Intensit�t: {movementIntensity:F2} | Schwelle: {intensityThreshold}");
        ...
        for (int i = 0; i < originalVerts.Length; i++)
        {
            ...
            float sway = Mathf.Sin(Time.time * 0.5f + v.y) * distortionValue * v.y; // Je h�her, desto mehr Bewegung
            v.x += sway;
            deformedVerts[i] = v;
        }
